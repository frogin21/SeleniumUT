...
public class TestScript {
    ...
    public String mobile_no;
     ...
     TestScript(String email) {
        ...
        this.nama = "Danamon WEB Empatbelas";
        this.alamat = "JL.Maengket 12 No.156 RT 05/013";
        this.no_ktp="5940011763909481";
        this.mobile_no="85362613811";
...
//        main.findElement(By.id("ap_dom_address")).sendKeys("domisili selenium"+ this.email, Keys.ENTER);
       ...
       Thread.sleep(1000);
        ...
        SupportController.waittoLoad(main.findElement(By.id("ap_employer_kab_kot")).findElement(By.cssSelector("option[value='434']")), wait);
        main.findElement(By.id("ap_employer_kab_kot")).sendKeys("Kota Jakarta Selatan", Keys.ENTER);
        SupportController.waittoLoad(main.findElement(By.id("ap_employer_kecamatan")).findElement(By.cssSelector("option[value='491']")), wait);
        main.findElement(By.id("ap_employer_kecamatan")).sendKeys("Tebet", Keys.ENTER);
        SupportController.waittoLoad(main.findElement(By.id("ap_employer_kelurahan")).findElement(By.cssSelector("option[value='4773']")), wait);
       ...
       String masukmanager;
        ...
        switch (masukmanager) {
            ...
            case "eka":
                ...
                break;
            case "manageraenrico":
                this.workbenchLogin("manageraenrico");
                break;
            case "fahmy_manager":
